...
\section{Gruppenhoperationen}
	...
	\begin{kor}
	$|G_x|=|G/G_x|=[G:G_x]$ Index
	\end{kor}
	
	\begin{proof}
	$p$ ist wohldefiniert: $\forall a,b,x \in G$ gilt:
	$$aG_x=b_Gx \Leftrightarrow b^{-1}ax=x \Leftrightarrow ax=bx \Leftrightarrow p(a)=p(b)$$
	D.h. $p$ ist wohldefiniert LA ich bijektiv.
	...
	$$|X|=\sum\limits_{\begin{subarray}{1}i \in I\end{subarray}}|G_{x_i}|=\sum\limits_{\begin{subarray}{1}i \in I\end{subarray}}[G:G_{x_i}]=|X^G|+\sum\limits_{\begin{subarray}{1}i \in I\\ x_i \notin X^G\end{subarray}}[G:G_{x_i}]$$
	
	
	\end{proof}
	
\newpage
% Hier fehlt die VL vom 2.6. (Isburg)
