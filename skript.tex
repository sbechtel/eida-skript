...
\begin{ex}
    \begin{enumerate}[label=(\alph*)]
        \item Für alle Gruppen $(G,\cdot)$ sind $\{e\}, G$ jeweils Untergruppen, die sogenannten \emph{trivialen Untergruppen}.
...
\begin{proof}
	\begin{enumerate}[label=(\roman*)]
		...
		\item Surjektivität: offensichtlich. Injektivität: vgl. Übung 2, Aufgabe 1.
	\end{enumerate}	
\end{proof}
